...
! last modified
! M. Wallin 2011-05-16
!  - Finite strain iso_Sntropic hardening implemented
! M. Wallin 2011-05-17
!  - init_J2_iso_Sn added
!  - accept_J2_iso_Sn added
! M. Wallin 2011-05-17
!  - material parameters added to J2iso_Sn_init
! M. Wallin 2011-05-17
!  - functionality J2iso_Sn_getVal added
! M. Ristinmaa 2011-05-19
!  - Changed arguments J2iso_Sn_getVal J2iso_Sn_init
!  - Private declaration of global variables
!  - Bugg J2iso_Sn_accept, New and Old was declared in routine
!  - Added routine for elements with one gauss point	
! M. Ristinmaa 2011-09-14
!  - changed in J2iso_Sn_accept, update wrong
...
interface J2iso_Sn_getVal
  module procedure J2iso_Sn_getValScalar
  module procedure J2iso_Sn_getValVector
end interface
private J2iso_Sn_getValScalar, J2iso_Sn_getValVector


interface J2iso_Sn_init
  module procedure init_J2_iso_Sn1
end interface
private init_J2_iso_Sn1


interface J2iso_Sn_accept
  module procedure accept_J2_iso_Sn1
  module procedure accept_J2_iso_Sn2
  module procedure accept_J2_iso_Sn3
end interface
private accept_J2_iso_Sn1


interface dJ2iso_Sn
  ! module procedure dJ2_iso_Sn_specificGP  
  module procedure dJ2_iso_Sn0
  module procedure dJ2_iso_Sn1
  module procedure dJ2_iso_Sn2
  module procedure dJ2_iso_Sn1_up
end interface
private dJ2_iso_Sn0, dJ2_iso_Sn1, dJ2_iso_Sn2


interface J2iso_Sn
  ! module procedure J2_iso_Sn_specificGP
  module procedure J2_iso_Sn0
  module procedure J2_iso_Sn1
  module procedure J2_iso_Sn2
  module procedure J2_iso_Sn1_up
end interface
private J2_iso_Sn0, J2_iso_Sn1, J2_iso_Sn2
...
subroutine J2iso_Sn_getValScalar(stype,out)
  implicit none
  integer                         :: ierr
  character(len=*)                :: stype
  ...
  return
end subroutine J2iso_Sn_getValScalar


subroutine J2iso_Sn_getValVector(stype,out)
  implicit none
  integer                         :: ierr
  character(len=*)                :: stype
  double precision, allocatable   :: out(:,:,:)
  ...
  return
end subroutine J2iso_Sn_getValVector

subroutine init_J2_iso_Sn1(mp,Nelm,Ngp)
  implicit none
  ...
  return
end subroutine init_J2_iso_Sn1


subroutine accept_J2_iso_Sn1
  implicit none
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2_iso_Sn1

! one gauss point per element
subroutine accept_J2_iso_Sn2(dg)
  implicit none
  double precision                :: dg(:,:)
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2_iso_Sn2

! more than one gauss point per element
subroutine accept_J2_iso_Sn3(dg)
  implicit none
  double precision                :: dg(:,:,:)
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2_iso_Sn3


subroutine J2_iso_Sn1_up(stype,stress,ef_New,th,ie)
  implicit none
  ...
  do gp=1,nr_gp
    call J2_iso_Sn2('Cauchy', stress(:,gp), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
                 ep, ef_New(:,gp) ,ie,gp)
  ...
  return
end subroutine J2_iso_Sn1_up


! Calculate stress for specific gauss point in the element
subroutine J2_iso_Sn_specificGP(stype,stress,ef_New,ie,gp)
  implicit none
  double precision                :: stress(:), ef_New(:)
  character(len=*)                :: stype
  integer                         :: gp, ie
  call J2_iso_Sn2(stype, stress(:), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
               ep, ef_New(:),ie, gp)

  return
end subroutine J2_iso_Sn_specificGP


subroutine J2_iso_Sn0(stype,stress,ef_New,ie)
  implicit none
  double precision                :: stress(:), ef_New(:)
  character(len=*)                :: stype
  integer                         :: gp, nr_gp,ie
  ...
  call J2_iso_Sn2(stype, stress(:), Isv(:,1,ie,old), Isv(:,1,ie,new), & 
                 ep, ef_New(:),ie,1)

  return
end subroutine J2_iso_Sn0


subroutine J2_iso_Sn1(stype,stress,ef_New,ie)
  implicit none
  double precision                :: stress(:,:), ef_New(:,:)
  character(len=*)                :: stype
  integer                         :: gp, nr_gp,ie
  ...
  do gp=1,nr_gp
    call J2_iso_Sn2(stype, stress(:,gp), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
                 ep, ef_New(:,gp),ie,gp)
  enddo

  return
end subroutine J2_iso_Sn1


subroutine J2_iso_Sn2(stype,stress,Isv_Old,Isv_New,ep,ef_New,ie,gp)
  implicit none
  ...
  return
end subroutine J2_iso_Sn2


subroutine dJ2_iso_Sn1_up(stype,D,ddwdjj,ef_New,th,ie)
  implicit none
  character(len=*)                :: stype
  ...
  do gp=1,nr_gp
    F_m=getF(ef_New(:,gp))
    Ja=det3(F_m)
    call dJ2_iso_Sn2('ul',D(:,:,gp),ep,ef_New(:,gp), &
  ...
  return
end subroutine dJ2_iso_Sn1_up


! Calculate D for a specific gauss point in that element
subroutine dJ2_iso_Sn_specificGP(stype,D,ef_New,ie,gp)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:), ef_New(:)
  integer                         :: gp, ie

  call dJ2_iso_Sn2(stype,D(:,:),ep,ef_New(:), Isv(:,gp,ie,Old), Isv(:,gp,ie,New),ie,gp)

  return
end subroutine dJ2_iso_Sn_specificGP



subroutine dJ2_iso_Sn0(stype,D,ef_New,ie)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:), ef_New(:)
  integer                         :: gp,nr_gp, ie

  call dJ2_iso_Sn2(stype,D(:,:),ep,ef_New(:), &
                  Isv(:,1,ie,Old), Isv(:,1,ie,New),ie,1)

  return
end subroutine dJ2_iso_Sn0


subroutine dJ2_iso_Sn1(stype,D,ef_New,ie)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:,:), ef_New(:,:)
  integer                         :: gp,nr_gp, ie
  ...
  do gp=1,nr_gp
    call dJ2_iso_Sn2(stype,D(:,:,gp),ep,ef_New(:,gp), &
                  Isv(:,gp,ie,Old), Isv(:,gp,ie,New),ie,gp)
  enddo

  return
end subroutine dJ2_iso_Sn1


subroutine dJ2_iso_Sn2(stype,Dout,ep,ef_New,Isv_Old,Isv_New,ie,gp)
  implicit none
  character(len=*)                :: stype
  double precision                :: ep(:), ef_New(:)
