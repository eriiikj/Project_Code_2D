...
interface J2IMCiso_getVal
  module procedure J2IMCiso_getValScalar
  module procedure J2IMCiso_getValVector
end interface
private J2IMCiso_getValScalar, J2IMCiso_getValVector


interface J2IMCiso_init
  module procedure init_J2IMC_iso1
end interface
private init_J2IMC_iso1


interface J2IMCiso_accept
  module procedure accept_J2IMC_iso1
  module procedure accept_J2IMC_iso2
  module procedure accept_J2IMC_iso3
end interface
private accept_J2IMC_iso1


interface dJ2IMCiso
  module procedure dJ2IMC_iso_specificGP
  module procedure dJ2IMC_iso0
  module procedure dJ2IMC_iso1
  module procedure dJ2IMC_iso2
  module procedure dJ2IMC_iso1_up
end interface
private dJ2IMC_iso0, dJ2IMC_iso1, dJ2IMC_iso2


interface J2IMCiso
  module procedure J2IMC_iso_specificGP
  module procedure J2IMC_iso0
  module procedure J2IMC_iso1
  module procedure J2IMC_iso2
  module procedure J2IMC_iso1_up
end interface
private J2IMC_iso0, J2IMC_iso1, J2IMC_iso2
...
subroutine J2IMCiso_getValScalar(stype,out)
  implicit none
  integer                         :: ierr
  character(len=*)                :: stype
  ...
  return
end subroutine J2IMCiso_getValScalar


subroutine J2IMCiso_getValVector(stype,out)
  implicit none
  integer                         :: ierr
  character(len=*)                :: stype
  double precision, allocatable   :: out(:,:,:)
  ...
  return
end subroutine J2IMCiso_getValVector

subroutine init_J2IMC_iso1(mp,Nelm,Ngp)
  implicit none
  integer                         :: Nisv, Ngp, Nelm, ierr
  double precision                :: mp(6)

  print *, 'Initiating J2IMC iso'
  Nisv=9
  ...
  return
end subroutine init_J2IMC_iso1


subroutine accept_J2IMC_iso1
  implicit none
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2IMC_iso1

! one gauss point per element
subroutine accept_J2IMC_iso2(dg)
  implicit none
  double precision                :: dg(:,:)
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2IMC_iso2

! more than one gauss point per element
subroutine accept_J2IMC_iso3(dg)
  implicit none
  double precision                :: dg(:,:,:)
...
! in the first iteration is calculated at the n-1 state
  ...
  return
end subroutine accept_J2IMC_iso3


subroutine J2IMC_iso1_up(stype,stress,ef_New,th,ie)
  implicit none
  ...
  do gp=1,nr_gp
    call J2IMC_iso2('Cauchy', stress(:,gp), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
                 ep, ef_New(:,gp) ,ie,gp)
  ...
  return
end subroutine J2IMC_iso1_up


! Calculate stress for specific gauss point in that element
subroutine J2IMC_iso_specificGP(stype,stress,ef_New,ie,gp)
  implicit none
  double precision                :: stress(:), ef_New(:)
  character(len=*)                :: stype
  integer                         :: gp, ie

  call J2IMC_iso2(stype, stress(:), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
               ep, ef_New(:),ie,gp)

  return
end subroutine J2IMC_iso_specificGP

! One Gauss point per element
subroutine J2IMC_iso0(stype,stress,ef_New,ie)
  implicit none
  double precision                :: stress(:), ef_New(:)
  character(len=*)                :: stype
  integer                         :: gp, nr_gp,ie
  ...
  call J2IMC_iso2(stype, stress(:), Isv(:,1,ie,old), Isv(:,1,ie,new), & 
                 ep, ef_New(:),ie,1)

  return
end subroutine J2IMC_iso0


subroutine J2IMC_iso1(stype,stress,ef_New,ie)
  implicit none
  double precision                :: stress(:,:), ef_New(:,:)
  character(len=*)                :: stype
  integer                         :: gp, nr_gp,ie
  ...
  do gp=1,nr_gp
    call J2IMC_iso2(stype, stress(:,gp), Isv(:,gp,ie,old), Isv(:,gp,ie,new), & 
                 ep, ef_New(:,gp),ie,gp)
  enddo

  return
end subroutine J2IMC_iso1


subroutine J2IMC_iso2(stype,stress,Isv_Old,Isv_New,ep,ef_New,ie,gp)
  implicit none
  ...
  return
end subroutine J2IMC_iso2


subroutine dJ2IMC_iso1_up(stype,D,ddwdjj,ef_New,th,ie)
  implicit none
  character(len=*)                :: stype
  ...
  do gp=1,nr_gp
    F_m=getF(ef_New(:,gp))
    Ja=det3(F_m)
    call dJ2IMC_iso2('ul',D(:,:,gp),ep,ef_New(:,gp), &
  ...
  return
end subroutine dJ2IMC_iso1_up


! Calculate D for a specific gauss point in that element
subroutine dJ2IMC_iso_specificGP(stype,D,ef_New, ie, gp)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:), ef_New(:)
  integer                         :: gp, ie

  call dJ2IMC_iso2(stype,D(:,:),ep,ef_New(:), &
                  Isv(:,gp,ie,Old), Isv(:,gp,ie,New),ie,gp)

  return
end subroutine dJ2IMC_iso_specificGP

! One gauss point per element
subroutine dJ2IMC_iso0(stype,D,ef_New,ie)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:), ef_New(:)
  integer                         :: gp,nr_gp, ie
  ...
  return
end subroutine dJ2IMC_iso0


subroutine dJ2IMC_iso1(stype,D,ef_New,ie)
  implicit none
  character(len=*)                :: stype
  double precision                :: D(:,:,:), ef_New(:,:)
  integer                         :: gp, nr_gp, ie
  ...
  do gp=1,nr_gp
    call dJ2IMC_iso2(stype,D(:,:,gp),ep,ef_New(:,gp), &
                  Isv(:,gp,ie,Old), Isv(:,gp,ie,New),ie,gp)
  enddo

  return
end subroutine dJ2IMC_iso1


subroutine dJ2IMC_iso2(stype,Dout,ep,ef_New,Isv_Old,Isv_New,ie,gp)
  implicit none
  character(len=*)                :: stype
  double precision                :: ep(:), ef_New(:)
...
end subroutine dJ2IMC_iso2


end module mater_J2iso_IMC